...
This is an R Markdown document to create the required coverage matrixes. The input is the vector of the normalized values from the genebody coverge script (coverage.r)file. In this file, each single-cell has a vector of numerical values. The each cell has a cell id with prefix ERR_
